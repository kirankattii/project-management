...
const ProjectHeader = ({activeTab,setActiveTab}: Props) => {
  ...
  return( <div className="px-4 xl:px-6">
    {/* MODEL NEW PROJECT */}
    <ModalNewProject isOpen={isModelNewProjectOpen } onClose={()=>setIsModelNewProjectOpen(false)} />
    <div className="pb-6 pt-6 lg:pb-4 lg:pt-8">
      <Header name="Product Design Development"
      buttonComponent={
        <button className="flex items-center rounded bg-blue-primary px-11 py-2 text-white hover:bg-blue-600"
        onClick={()=>setIsModelNewProjectOpen(true)}
        >
          <PlusSquare className="h-5 w-5 mr-2"/>New Boards
        </button>
      }
      />
